...
public class DlgPilihDokter extends javax.swing.JDialog {
    ...
    public DlgPilihDokter(java.awt.Frame parent, boolean id) {
        ...
        initComponents();
//        setSize(628,674); 
        tabmode=new DefaultTableModel(new Object[]{"Kode","Nama Dokter","Kuota","Hari Praktek","Jam Praktek","Selesai Praktek"},0){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        
        tbAdmin.setModel(tabmode);
        tbAdmin.setPreferredScrollableViewportSize(new Dimension(1400,500));
//        tbAdmin.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 204, 255)), "::[ Silahkan Pilih Dokter ]::", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(153, 204, 255))); // NOI18N
    ...
    public void tampil(){
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select dokter.kd_dokter,dokter.nm_dokter,jadwal.kuota,jadwal.hari_kerja,jadwal.jam_mulai,jadwal.jam_selesai "+
...
//                ps.setString(7,hari);
//                ps.setString(8,LblKdPoli.getText());
