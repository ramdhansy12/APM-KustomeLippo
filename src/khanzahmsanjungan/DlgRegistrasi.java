...
public class DlgRegistrasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel18.setBounds(20, 240, 160, 25);
        ...
        jLabel19.setBounds(180, 240, 20, 25);

        PngJawab.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        PngJawab.setBounds(200, 290, 350, 50);
        ...
        HubunganPngJawab.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        HubunganPngJawab.setBounds(200, 230, 350, 50);
        ...
        jLabel22.setBounds(180, 360, 20, 25);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("Alamat P. J.");
        jLabel23.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel2.add(jLabel23);
        jLabel23.setBounds(20, 360, 160, 25);

        AlamatPngJawab.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        AlamatPngJawab.setBounds(200, 350, 350, 50);
        ...
        jPanel2.add(Status);
        Status.setBounds(200, 410, 350, 50);
        ...
        jLabel24.setBounds(180, 420, 20, 25);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("Status Pasien");
        jLabel25.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel2.add(jLabel25);
        jLabel25.setBounds(20, 420, 160, 25);
        ...
        jLabel26.setBounds(180, 490, 20, 25);

        KdBayar.setEditable(false);
        KdBayar.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        jPanel2.add(KdBayar);
        KdBayar.setBounds(200, 480, 68, 50);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("Jenis Bayar");
        jLabel27.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel2.add(jLabel27);
        jLabel27.setBounds(20, 490, 160, 25);

        NmBayar.setEditable(false);
        NmBayar.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        ...
        jPanel2.add(NmBayar);
        NmBayar.setBounds(270, 480, 280, 50);
        ...
        btnSemua.setBounds(560, 480, 60, 50);
        ...
        btnSimpan.setBounds(610, 360, 110, 35);
        ...
        btnKeluar.setBounds(750, 360, 110, 35);
...
//                    
//                }
                String status = fungsi.koneksiDB.AKTIFKANPRINTBARCODEOTOMATIS();
                if ("someValue".equals(status)) { 
                    // Lakukan sesuatu
                    MnCetakBarcodeRawatJalan(NoRawat.getText());
                }


                // Kirim data ke WebSocket (jika diperlukan)
                String datajam = Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Sequel.cariIsi("select current_time()");
                JSONObject jsonData = new JSONObject();
                try {
                    jsonData.put("NoRawat", LblNoRawat.getText());
                    jsonData.put("TaskID", "3");
...
//        } else if (Sequel.cariInteger("select count(no_rkm_medis) from reg_periksa where kd_pj='A09' and no_rkm_medis='" + LblNoRm.getText() + "' and kd_poli='" + kode_poli + "' and kd_dokter='" + kode_dokter + "' and tgl_registrasi='" + Valid.SetTgl(Tanggal.getSelectedItem() + "") + "' ") > 0) {
...
//            isCekPasien();
//
//            // Ambil kode penjamin yang dipilih
//            String selectedPenjab = cmbCaraBayar.getSelectedItem().toString();
//            String kdPj = Sequel.cariIsi("SELECT kd_pj FROM penjab WHERE png_jawab=?", selectedPenjab);
//
//            if (Sequel.menyimpantf2("reg_periksa", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 19,
//                    new String[]{
//                        NoReg.getText(), 
...
//                        "Lama", 
//                        "Ralan", 
//                        kdPj, // Gunakan kode penjamin yang dipilih
//                        umur, 
//                        sttsumur, 
//                        "Belum Bayar", 
//                        status
