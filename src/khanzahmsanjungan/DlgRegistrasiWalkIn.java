...
public class DlgRegistrasiWalkIn extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-02-2025" }));
        ...
        cmbCaraBayar.setBounds(500, 30, 520, 40);
        ...
        btnSemua.setBounds(810, 230, 70, 40);
        ...
        jPanel2.add(jPanel3);
        jPanel3.setBounds(0, 360, 1283, 200);
        ...
        jPanel2.add(KdBayar);
        KdBayar.setBounds(460, 240, 68, 26);
        ...
        jPanel2.add(NmBayar);
        NmBayar.setBounds(550, 240, 248, 26);
...
//    }
    ...
    private void tampilPenjab() {
    try {
        cmbCaraBayar.removeAllItems(); // Kosongkan combobox
        ps = koneksi.prepareStatement("SELECT kd_pj, png_jawab FROM penjab WHERE status='1' ORDER BY kd_pj");
        rs = ps.executeQuery();
        while (rs.next()) {
            cmbCaraBayar.addItem(rs.getString("png_jawab")); // Tambahkan nama penjamin ke combobox
        }
    } catch (Exception e) {
        System.out.println("Notifikasi : " + e);
    } finally {
