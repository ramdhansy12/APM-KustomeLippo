...
public class HalamanUtamaDepan extends javax.swing.JFrame {
    ...
    public HalamanUtamaDepan() {
        ...
        setIconImage(new ImageIcon(super.getClass().getResource("/picture/lippo.png")).getImage());
    ...
    private void initComponents() {
        ...
        jLabel39.setForeground(new java.awt.Color(102, 204, 255));
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/logorspklc.png"))); // NOI18N
        PanelWall.setForeground(new java.awt.Color(204, 204, 204));
        PanelWall.setPreferredSize(new java.awt.Dimension(600, 180));
        PanelWall.setRound(false);
        PanelWall.setLayout(new java.awt.CardLayout());
        ...
        btnAdmin8.setForeground(new java.awt.Color(102, 204, 255));
        ...
        btnAdmin2.setForeground(new java.awt.Color(102, 204, 255));
        btnAdmin2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/kioskselfservice.png"))); // NOI18N
        btnAdmin2.setText("Pedaftaran Poliklinik ( Asuransi & Umum)");
        ...
        btnAdmin7.setForeground(new java.awt.Color(102, 204, 255));
        ...
        btnAdmin5.setForeground(new java.awt.Color(102, 204, 255));
        ...
        btnAdmin9.setForeground(new java.awt.Color(102, 204, 255));
        ...
        btnAdmin6.setForeground(new java.awt.Color(0, 204, 255));
        ...
        btnAdmin11.setForeground(new java.awt.Color(102, 204, 255));
        ...
        btnAdmin10.setForeground(new java.awt.Color(204, 204, 204));
...
//        JOptionPane.showMessageDialog(rootPane, "Mohon maaf, fitur masih dalam tahap pengembangan");
    ...
    private void btnAdmin11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdmin11ActionPerformed
        ...
        Valid.panggilUrl("kyc-library-php/index.php?&nikagent=" + nikktppetugas + "");
