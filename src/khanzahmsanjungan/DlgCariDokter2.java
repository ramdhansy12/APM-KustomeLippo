...
public final class DlgCariDokter2 extends javax.swing.JDialog {
    ...
    public DlgCariDokter2(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode Dokter", "Nama Dokter","Hari Praktek","Jam Praktek","Selesai Praktek"};
//        Object[] row = {"Kode Dokter", "Nama Dokter","Hari Praktek","Jam Praktek","Selesai Praktek"};
...
//                rs = ps.executeQuery();
//                while (rs.next()) {
//                    tabMode.addRow(new Object[]{rs.getString(2), rs.getString(1), rs.getString(3), rs.getString(4), rs.getString(5)});
//                }
//            } catch (Exception e) {
